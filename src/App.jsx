...
*/
  ...
  return (
    <div className='main-container'>
      ...
      <form>
        <label>
          <input type='range' name='brightness' min={0} max={2} step={0.1} value={filter.brightness} onChange={handleInputChange} />
          <span>Brightness</span>
        </label>

        <label>
          <input type='range' name='contrast' min={0} max={2} step={0.1} value={filter.contrast} onChange={handleInputChange} />
          <span>Contrast</span>
        </label>

        <label>
          <input type='range' name='saturation' min={0} max={2} step={0.1} value={filter.saturation} onChange={handleInputChange} />
